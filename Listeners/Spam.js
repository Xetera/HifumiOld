...
function checkForSpam(message) {
    return __awaiter(this, void 0, void 0, function () {
        var channel, author_1, threshold_1, messages, userMessages, tolerance, deletedMessages, deletedMessagesCount, muted_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 6:
                    ...
                    muted_1 = message.guild.roles.find('name', 'muted');
                    if (!muted_1)
                        return [2 /*return*/, Logging_1.debug.warning("Spammer " + author_1.username + " could not be muted, missing 'muted' role.")];
                    message.member.addRole(muted_1).then(function () {
                        Logging_1.log(message.member.guild, "[" + author_1.username + "] was muted for " + Settings_1.getMuteDuration() / 1000 + " seconds for spamming.");
                        setTimeout(function () {
                            message.member.removeRole(muted_1);
                        }, Settings_1.getMuteDuration());
                    });
                    _a.label = 7;
